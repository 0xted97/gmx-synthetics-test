...
export function orderKey(dataStoreAddress: string, nonce: number) {
...
export function gasLimitTransferTokenKey(token: string) {
    return hashData(["bytes32", "address"], [TOKEN_TRANSFER_GAS_LIMIT_KEY, token]);
  }
